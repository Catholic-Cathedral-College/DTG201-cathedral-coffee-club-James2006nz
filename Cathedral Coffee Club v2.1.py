...
def payment ():
    ...
    if paymentmethod == "cash" or paymentmethod == "CASH" or paymentmethod == "Cash":
        print(".")
    elif paymentmethod == "eftpos" or paymentmethod == "Eftpos" or paymentmethod == "EFTPOS":
        print(".")
    elif paymentmethod == "contactless" or paymentmethod == "CONTACTLESS" or paymentmethod == "Contactless":
        print(".")
    elif paymentmethod == "voucher" or paymentmethod == "VOUCHER" or paymentmethod == "Voucher":
        print(".")
    else:
