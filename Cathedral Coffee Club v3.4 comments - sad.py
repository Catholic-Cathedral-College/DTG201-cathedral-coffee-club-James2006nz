...
def orders ():
    ...
    while active == False:
        ...
        print("")
        more()
#Function - does the user want to order another drink?
def more ():
    global orders
    active = False
    global sugars
...
#Function - does the person want sugar in their drinks?
def sugars ():
    global sugar
    global payment
    active = False
    while active == False:
        ...
        if sugar == "yes" or sugar == "Yes" or sugar == "YES":
            ...
            sugars()
#Function - total for payment and how does the person want to pay for their drinks? - supported payment methods
def payment ():
    global cartlist
    global name
    active = False
    while active == False:
        ...
        if paymentmethod == "cash" or paymentmethod == "CASH" or paymentmethod == "Cash" or paymentmethod == "eftpos" or paymentmethod == "Eftpos" or paymentmethod == "EFTPOS" or paymentmethod == "contactless" or paymentmethod == "CONTACTLESS" or paymentmethod == "Contactless" or paymentmethod == "voucher" or paymentmethod == "VOUCHER" or paymentmethod == "Voucher" or paymentmethod == "Coupon" or paymentmethod == "COUPON" or paymentmethod == "coupon":
            ...
            payment()
#Introduction/introductionary message and call to functions
print("")
